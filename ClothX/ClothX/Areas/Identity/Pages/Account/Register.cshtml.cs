	...
	public class RegisterModel : PageModel
	{
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				// make this false when email is configured
				...
				if (result.Succeeded)
				{
					...
					{
						await MailSenderService.Instance.SendMailToUserOnRegister(Input.Email, Input.FirstName + " " + Input.LastName, HtmlEncoder.Default.Encode(callbackUrl));
